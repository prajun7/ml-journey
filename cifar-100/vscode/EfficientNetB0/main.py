...
from tensorflow.keras.applications import EfficientNetB0  # Added for EfficientNetB0
...
# Defining the Keras Sequential model using EfficientNetB0 (with Batch Norm, L2, Softmax output)...
print("Defining the Keras Sequential model using EfficientNetB0 (with Batch Norm, L2, Softmax output)...")

# Load EfficientNetB0 with pre-trained ImageNet weights, excluding top layers
...
print("Model defined successfully with EfficientNetB0, Batch Norm, L2, and Softmax output.")
model.summary()
